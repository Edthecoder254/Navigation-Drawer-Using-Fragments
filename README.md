...
However, If you want to add Navigation Drawer Activity to an existing project you can add it by going to your package -> right click -> new -> activity -> navigation drawer activity


Open the MainActivity tab and it should have the following sample code
